    ...
    return (
        <div className="container">
            ...
            <div className="goods">
                ...
                <Card image={p780} name='Станок для заточки протяжек 780-ой серии' link = '/p531'/>
                <Card image={p721} name='Станок для заточки червячных фрез 721-ой серии' link = '/p531'/>
                <Card image={p676} name='Полуавтомат зубошлифовальный с ЧПУ 676-ой серии' link = '/p531'/>
                <Card image={p681} name='Станок резьбошлифовальный с ЧПУ 681-ой серии' link = '/p531'/>
                <Card image={p818} name='Заточной станок ВЗ-818Е' link = '/p531'/>
                <Card image={p3e692} name='Полуавтомат заточной для дисковых пил 3Е692' link = '/p531'/>
                <Card image={p400} name='Стенд для испытания шлифовальных кругов на разрыв вращением СР-400В' link = '/p531'/>
